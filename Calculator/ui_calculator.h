...
public:
    ...
    void setupUi(QMainWindow *Calculator)
    {
        ...
        Calculator->resize(482, 555);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(Calculator->sizePolicy().hasHeightForWidth());
        Calculator->setSizePolicy(sizePolicy);
        actionStandard = new QAction(Calculator);
        actionStandard->setObjectName(QStringLiteral("actionStandard"));
        actionScientific = new QAction(Calculator);
        actionScientific->setObjectName(QStringLiteral("actionScientific"));
...
"}"));
    ...
    void retranslateUi(QMainWindow *Calculator)
    {
        ...
        actionStandard->setText(QApplication::translate("Calculator", "Standard", nullptr));
        actionScientific->setText(QApplication::translate("Calculator", "Scientific", nullptr));
